...
const request = Buffer.from([
  0x17, 0xa8, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x20, 0x21, 0x01, 0x01, 0x20, 0x21, 0x12, 0x31, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00,
  0x08, 0x30, 0x03, 0x04, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
])

const reply = Buffer.from([
  0x17, 0xa8, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
describe('#addTask(...) (TCP)', function () {
  ...
  it('should execute add-task with address:port string', function (done) {
    ...
    uhppoted
      .addTask(ctx, { id: 405419896, address: '127.0.0.1:59998', protocol: 'tcp' }, task)
      .then((response) => {
        expect(response).to.deep.equal(expected)
        done()
      })
