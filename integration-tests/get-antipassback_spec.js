...
describe('#getAntiPassback(...)', function () {
  let sock = null
...
describe('#getAntiPassback(...) (TCP)', function () {
  let sock = null
  ...
  it('should execute get-antipassback using TCP with address:port object', function (done) {
    const expected = {
      deviceId: 405419896,
      antipassback: {
        code: 2,
  ...
  it('should execute get-antipassback using TCP with address:port string', function (done) {
    const expected = {
      deviceId: 405419896,
      antipassback: {
        code: 2,
