...
const request = Buffer.from([
  0x17, 0x5c, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
])

const reply = Buffer.from([
  0x17, 0x5c, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0xa3, 0x98, 0x7c, 0x00, 0x20, 0x23, 0x01, 0x01, 0x20, 0x23, 0x12, 0x31, 0x01, 0x00, 0x1d,
...
describe('#getCardByIndex(...)', function () {
  ...
  it('should execute get-card-by-index', function (done) {
    ...
    uhppoted
      .getCardByIndex(ctx, 405419896, 2)
      .then((response) => {
...
describe('#getCardByIndex(...) (TCP)', function () {
  ...
  it('should execute get-card-by-index using TCP with address:port string', function (done) {
    ...
    uhppoted
      .getCardByIndex(ctx, { id: 405419896, address: '127.0.0.1:59998', protocol: 'tcp' }, 2)
      .then((response) => {
        expect(response).to.deep.equal(expected)
        done()
      })
