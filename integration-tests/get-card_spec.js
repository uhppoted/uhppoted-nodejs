...
const request = Buffer.from([
  0x17, 0x5a, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0xa2, 0x98, 0x7c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
])

const reply = Buffer.from([
  0x17, 0x5a, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0xa2, 0x98, 0x7c, 0x00, 0x20, 0x23, 0x01, 0x01, 0x20, 0x23, 0x12, 0x31, 0x01, 0x00, 0x1d,
...
describe('#getCard(...) (TCP)', function () {
  ...
  it('should execute get-card using TCP with address:port string', function (done) {
    ...
    uhppoted
      .getCard(ctx, { id: 405419896, address: '127.0.0.1:59998', protocol: 'tcp' }, 8165538)
      .then((response) => {
        expect(response).to.deep.equal(expected)
        done()
      })
