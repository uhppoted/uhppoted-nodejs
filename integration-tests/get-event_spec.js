...
const requests = [
  // normal event
  Buffer.from([
    0x17, 0xb0, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x1d, 0x00, 0x00, 0x00,
  ...
  // missing event
  Buffer.from([
    0x17, 0xb0, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0xc8, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  // overwritten event
  Buffer.from([
    0x17, 0xb0, 0x00, 0x00, 0x90, 0x53, 0xfb, 0x0b, 0x49, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const replies = [
  ...
  Buffer.from([
    0x17, 0xb0, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x1d, 0x00, 0x00, 0x00,
    0x02, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x20, 0x19, 0x08, 0x03,
    0x10, 0x34, 0x29, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,
  ]),
  ...
  // missing event
  Buffer.from([
    0x17, 0xb0, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  // overwritten event
  Buffer.from([
    0x17, 0xb0, 0x00, 0x00, 0x90, 0x53, 0xfb, 0x0b, 0x00, 0x00, 0x00, 0x00,
    ...
    uhppoted
      ...
      .catch((err) => {
        expect(err.toString()).to.equal(
          'Error: 405419896:200  event does not exist',
        )
        done()
      })
  })
...
describe('#getEvent(...) with overwritten event', function (_done) {
  ...
  it("should return 'overwritten' error for get-event with index before first event", function (done) {
    uhppoted
      ...
      .catch((err) => {
        expect(err.toString()).to.equal(
          'Error: 201020304:73  event overwritten',
        )
        done()
      })
  })
