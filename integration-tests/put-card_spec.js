...
describe('#putCard(...)', function () {
  ...
  it('should execute put-card', function (done) {
    ...
    uhppoted.putCard(ctx, 405419896, 123456789, '2023-01-01', '2025-12-31', { 1: true, 2: false, 3: 29, 4: true })
      .then(response => {
...
describe('#putCard(...) with PIN', function () {
  ...
  it('should execute put-card (with PIN)', function (done) {
    ...
    uhppoted.putCard(ctx, 405419896, 123456789, '2023-01-01', '2025-12-31', { 1: true, 2: false, 3: 29, 4: true }, 7531)
      .then(response => {
        expect(response).to.deep.equal(expected)
        done()
      })
