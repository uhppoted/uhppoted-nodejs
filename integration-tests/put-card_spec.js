...
const request = Buffer.from([
  ...
  0x20, 0x25, 0x12, 0x31, 0x01, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
describe('#putCard(...)', function () {
  ...
  it('should execute put-card', function (done) {
    ...
    uhppoted.putCard(ctx, 405419896, 123456789, '2021-01-01', '2025-12-31', { 1: true, 2: false, 3: true, 4: true })
      .then(response => {
