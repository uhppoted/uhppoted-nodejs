...
const request = Buffer.from([
  0x17, 0x88, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x1d, 0x20, 0x21, 0x01, 0x01, 0x20, 0x21, 0x12, 0x31, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00,
  0x00, 0x08, 0x30, 0x11, 0x45, 0x13, 0x15, 0x17, 0x25, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
])

const reply = Buffer.from([
  0x17, 0x88, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
describe('#setTimeProfile(...) (TCP)', function () {
  ...
  it('should execute set-time-profile with address:port string', function (done) {
    ...
    uhppoted
      .setTimeProfile(ctx, { id: 405419896, address: '127.0.0.1:59998', protocol: 'tcp' }, profile)
      .then((response) => {
        expect(response).to.deep.equal(expected)
        done()
      })
