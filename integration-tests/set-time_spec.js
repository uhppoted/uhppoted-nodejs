...
const request = Buffer.from([
  0x17, 0x30, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x20, 0x21, 0x05, 0x28, 0x14, 0x56, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
describe('#setTime(...) (TCP)', function () {
  ...
  it('should execute set-time using TCP with address:port string', function (done) {
    ...
    uhppoted
      .setTime(ctx, { id: 405419896, address: '127.0.0.1:59998', protocol: 'tcp' }, '2021-05-28 14:56:14')
      .then((response) => {
        expect(response).to.deep.equal(expected)
        done()
      })
