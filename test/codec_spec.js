...
describe('codec', function () {
  describe('#encode(...)', function () {
    ...
    it('should encode set-listener request', function () {
      ...
      const bytes = codec.encode(opcodes.SetListener, 405419896, { address: '192.168.1.100', port: 60001, interval: 15 })
  ...
  describe('#decode(...)', function () {
    ...
    it('should decode get-time response', function () {
      ...
      const msg = Buffer.from([
        0x17, 0x32, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x20, 0x24, 0x10, 0x08, 0x12, 0x34, 0x56, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
      ])
