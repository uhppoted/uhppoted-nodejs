...
describe('encoder', function () {
  it('should encode set-ip request', function () {
    ...
    const expected = Buffer.from([
      0x17, 0x96, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0xc0, 0xa8, 0x01, 0x64, 0xff, 0xff, 0xff, 0x00, 0xc0, 0xa8, 0x01, 0x01, 0x55, 0xaa,
  ...
  it('should encode set-listener request', function () {
    ...
    const expected = Buffer.from([
      0x17, 0x90, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0xc0, 0xa8, 0x01, 0x64, 0x61, 0xea, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  it('should encode get-antipassback request', function () {
    ...
    const request = encoder.GetAntiPassback(controller)
  ...
  it('should encode set-antipassback request', function () {
    ...
    const request = encoder.SetAntiPassback(controller, { antipassback })
